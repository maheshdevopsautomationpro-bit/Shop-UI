                    ...
                    <section className="mb-8">
                        ...
                        <ul className="list-disc pl-6 text-gray-600 space-y-2">
                            <li>
                                ...
                                contact information you provide when contacting us or placing an order.
                            </li>
                            <li>
                                <strong>Transaction Data:</strong> Information about purchases, payment details,
                                and order history.
                            </li>
                            <li>
                    ...
                    <section className="mb-8">
                        ...
                        <ul className="list-disc pl-6 text-gray-600 space-y-2">
                            <li>
                                ...
                                on our behalf, such as payment processing and delivery.
                            </li>
                            <li>
